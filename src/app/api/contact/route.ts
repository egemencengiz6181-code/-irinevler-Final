    ...
    if (type === 'analysis') {
      ...
      html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #05010d; color: #f2f2f2; padding: 32px; border-radius: 16px; border: 1px solid #2d1b66;">
          ...
          <p style="color: #4a4a4a; font-size: 12px;">Halkalı Fen Bilimleri — Ön Görüşme Sistemi</p>
        </div>
      `;
    } else {
      ...
      html = `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #05010d; color: #f2f2f2; padding: 32px; border-radius: 16px; border: 1px solid #2d1b66;">
          ...
          <hr style="border: none; border-top: 1px solid #2d1b66; margin: 32px 0;" />
          <p style="color: #4a4a4a; font-size: 12px;">Halkalı Fen Bilimleri — İletişim Sistemi</p>
        </div>
      `;
    }

    await transporter.sendMail({
      from: '"Halkalı Fen Bilimleri" <nazmiarikanfenbilimlerihalkali@gmail.com>',
      to: 'nazmiarikanfenbilimlerihalkali@gmail.com',
      subject,
      html,
    });
