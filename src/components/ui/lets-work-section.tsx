      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          >
            ...
            <a
              href="mailto:sirinevlerfinalozelogretim@abdkurumlari.com"
            ...
            >
              ...
              <span className="font-light text-sm sm:text-base truncate">sirinevlerfinalozelogretim@abdkurumlari.com</span>
            </a>
          </motion.div>
