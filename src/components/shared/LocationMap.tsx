...
export default function LocationMap() {
  return (
    <section className="w-full h-[450px] relative overflow-hidden group bg-background">
      <iframe
        src="https://maps.google.com/maps?q=Fatih+Cad.+No:18/1,+Halkal%C4%B1+Merkez,+K%C3%BC%C3%A7%C3%BCk%C3%A7ekmece,+%C4%B0stanbul&t=&z=16&ie=UTF8&iwloc=&output=embed"
        width="100%"
        height="100%"
        ...
        title="Halkalı Fen Bilimleri Dershanesi"
      />
      ...
      >
        ...
        <div className="text-slate-900 dark:text-white font-medium">Fatih Cd. No : 18/1, Halkalı Merkez</div>
